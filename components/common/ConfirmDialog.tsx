      ...
      >
        ...
        <div className={`flex items-start gap-4 p-6 border-b ${styles.border}`}>
          <div className={`flex-shrink-0 w-10 h-10 rounded-full ${styles.iconBg} flex items-center justify-center`}>
            <Icon icon={styles.icon} className={`${styles.iconColor} w-6 h-6`} />
          </div>
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">{dialog.title}</h3>
...
export const ConfirmDialogContainer: React.FC<ConfirmDialogContainerProps> = ({ dialogs }) => {
