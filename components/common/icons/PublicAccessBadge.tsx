...
export interface PublicAccessBadgeProps
...
const baseClass =
	"inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium border select-none";

export default function PublicAccessBadge({
	accessLevel,
	onToggle,
	size = "sm",
	isTemplate = false,
