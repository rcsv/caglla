...
export default function ReservationTemplateModal({
	...
	const [editingTemplate, setEditingTemplate] =
		useState<ReservationTemplate | null>(null);
					...
					{showCreateForm && (
						<div className="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg space-y-4">
							...
							<Select
								...
								options={getReservationTypes().map((type) => ({
									value: type.value,
							...
							<Select
								...
								onChange={(e) =>
									setFormData({
										...formData,
										reservation_site: e.target.value as any,
									})
								}
								options={[
									{ value: "", label: t("reservation.notSet") },
