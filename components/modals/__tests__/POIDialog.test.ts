...
describe('parseOpeningHours', () => {
  ...
  it('parses English opening hours and detects open status', () => {
    ...
    const result = parseOpeningHours(weekdayText, 'en', new Date('2024-03-04T10:30:00')) // Monday
  ...
  it('parses Japanese 24 hour schedule', () => {
    ...
    const result = parseOpeningHours(weekdayText, 'ja', new Date('2024-03-05T02:15:00')) // Tuesday
  ...
  it('handles closed day detection', () => {
    ...
    const result = parseOpeningHours(weekdayText, 'en', new Date('2024-03-04T12:00:00')) // Monday
