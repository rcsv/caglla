					...
					<div>
						...
						<div className="space-y-2">
							<label
								...
								style={{
									borderColor: exportType === "trip" ? "#3B82F6" : "#E5E7EB",
								}}
							>
								<input
									type="radio"
							...
							<label
								...
								style={{
									borderColor:
										exportType === "reservations" ? "#3B82F6" : "#E5E7EB",
								}}
							>
								<input
									type="radio"
						...
						<div className="grid grid-cols-3 gap-3">
							...
							>
								...
								<div className="flex-1">
									...
									<p className="text-xs text-gray-600 mt-1">完全なデータ構造</p>
								</div>
							</label>
							...
							>
								...
								<div className="flex-1">
									...
									<p className="text-xs text-gray-600 mt-1">Excel対応</p>
								</div>
							</label>
							...
							<label
								className="flex items-center p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors"
								style={{
									borderColor: exportFormat === "ical" ? "#3B82F6" : "#E5E7EB",
								}}
							>
								<input
									type="radio"
								...
								<div className="flex-1">
									...
									<p className="text-xs text-gray-600 mt-1">カレンダー連携</p>
								</div>
							</label>
						</div>
					</div>
