...
export default function ICalPublishModal({ isOpen, onClose, trip, onUpdate }: ICalPublishModalProps) {
  const { userPlan } = useSubscription()
  const [isLoading, setIsLoading] = useState(false)
  const [icalUrls, setICalUrls] = useState<{ trip: string; reservations: string } | null>(null)
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button
                    onClick={() => handleCopyUrl(icalUrls.reservations, 'reservations')}
                    variant="secondary"
                    className="flex items-center gap-2"
                  >
