...
export default function ImageUpload({
	...
	const processFile = async (file: File) => {
		...
		try {
			...
			if (error instanceof Error) {
				...
				} = await import("@/lib/storage/storage-error-codes");
	...
	const handleRemoveImage = async () => {
		...
		try {
			...
			await imageUploadHelpers.deleteImage(currentImageUrl, userId, fileId);
			...
			const errorMessage =
				error instanceof Error ? error.message : t("imageUpload.unknownError");
