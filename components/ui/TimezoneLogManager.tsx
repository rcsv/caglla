	...
	return (
		<div className="p-6 max-w-4xl mx-auto">
			...
			<div className="flex gap-4 mb-6">
				...
				>
					{showDetails
						? t("timezoneLog.hideDetails")
						: t("timezoneLog.showDetails")}
				</button>
			</div>
			...
			{updates.length > 0 && (
				<div className="mb-6">
					<h2 className="text-xl font-semibold mb-4">
						{t("timezoneLog.latestBatchResults")}
					</h2>
						...
						{logs.slice(0, 20).map((log) => (
							<div key={log.id} className="bg-white border rounded-lg p-4">
								...
								<div className="text-sm text-gray-500">
									...
									{log.detected_country && (
										<p>検出国: {log.detected_country}</p>
									)}
									<p>
										作成日時:{" "}
										{toDateOrNull(log.created_at)?.toLocaleString("ja-JP") ||
											"N/A"}
									</p>
								</div>
							</div>
			...
			<div className="mt-8 bg-blue-50 p-4 rounded-lg">
				<h3 className="font-semibold text-blue-800 mb-2">
					{t("timezoneLog.aboutBatchProcessing")}
				</h3>
