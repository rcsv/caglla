...
> = {
	transportation: {
		primary:
			"bg-sky-50 border-sky-200 text-sky-900 focus:ring-sky-500 focus:border-sky-500",
		secondary:
			"bg-sky-100 border-sky-300 text-sky-900 focus:ring-sky-500 focus:border-sky-500",
	},
	shopping: {
		primary:
			"bg-amber-50 border-amber-200 text-amber-900 focus:ring-amber-500 focus:border-amber-500",
		secondary:
			"bg-amber-100 border-amber-300 text-amber-900 focus:ring-amber-500 focus:border-amber-500",
	},
	dining: {
		primary:
			"bg-orange-50 border-orange-200 text-orange-900 focus:ring-orange-500 focus:border-orange-500",
		secondary:
			"bg-orange-100 border-orange-300 text-orange-900 focus:ring-orange-500 focus:border-orange-500",
	},
	accommodation: {
		primary:
			"bg-rose-50 border-rose-200 text-rose-900 focus:ring-rose-500 focus:border-rose-500",
		secondary:
			"bg-rose-100 border-rose-300 text-rose-900 focus:ring-rose-500 focus:border-rose-500",
	},
	exploration: {
		primary:
			"bg-emerald-50 border-emerald-200 text-emerald-900 focus:ring-emerald-500 focus:border-emerald-500",
		secondary:
			"bg-emerald-100 border-emerald-300 text-emerald-900 focus:ring-emerald-500 focus:border-emerald-500",
	},
	adventure: {
		primary:
			"bg-teal-50 border-teal-200 text-teal-900 focus:ring-teal-500 focus:border-teal-500",
		secondary:
			"bg-teal-100 border-teal-300 text-teal-900 focus:ring-teal-500 focus:border-teal-500",
	},
	entertainment: {
		primary:
			"bg-violet-50 border-violet-200 text-violet-900 focus:ring-violet-500 focus:border-violet-500",
		secondary:
			"bg-violet-100 border-violet-300 text-violet-900 focus:ring-violet-500 focus:border-violet-500",
	},
	culture: {
		primary:
			"bg-indigo-50 border-indigo-200 text-indigo-900 focus:ring-indigo-500 focus:border-indigo-500",
		secondary:
			"bg-indigo-100 border-indigo-300 text-indigo-900 focus:ring-indigo-500 focus:border-indigo-500",
	},
	wellness: {
		primary:
			"bg-lime-50 border-lime-200 text-lime-900 focus:ring-lime-500 focus:border-lime-500",
		secondary:
			"bg-lime-100 border-lime-300 text-lime-900 focus:ring-lime-500 focus:border-lime-500",
	},
	service: {
		primary:
			"bg-slate-50 border-slate-200 text-slate-900 focus:ring-slate-500 focus:border-slate-500",
		secondary:
			"bg-slate-100 border-slate-300 text-slate-900 focus:ring-slate-500 focus:border-slate-500",
	},
};
