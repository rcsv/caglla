...
export default function TripItineraryView({
  ...
  const generateItinerarySummary = (day: Day): string => {
    if (!day.itineraries || day.itineraries.length === 0) return ''
                  ...
                  <div className="flex-1">
                    ...
                    {isCollapsed && (
                      <div className="text-sm text-gray-600">
                        ...
                        {itinerarySummary && <p className="text-gray-500">{itinerarySummary}</p>}
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="px-6 pb-6">
                    <DayEditor
                      ...
                      onUpdate={(updatedDay: any) => {
                        onUpdateTrip({
                          ...trip,
                          days: trip.days?.map((d) => (d.id === updatedDay.id ? (updatedDay as any) : d)) || [],
                        })
                      }}
                    />
                              ...
                              >
                                <div className="space-y-0">
                                  {sortedItineraries.map((itinerary, index) => {
                                    ...
                                    const nextItinerary =
                                      index < sortedItineraries.length - 1 ? sortedItineraries[index + 1] : null
