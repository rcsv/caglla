  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="space-y-3 mb-6">
        <h4 className="text-sm font-medium text-gray-600">{t('activity.analysis.categoryDistribution')}</h4>
      ...
      <div className="space-y-2 border-t border-gray-200 pt-4">
        <h4 className="text-sm font-medium text-gray-600 mb-3">{t('activity.analysis.detailsTop5')}</h4>
        {sortedSecondaryCategories.map(([key, count]) => {
          ...
          return (
            <div key={key} className="flex justify-between items-center text-sm">
              ...
              <span className="text-gray-800 font-medium">{count}{t('activity.analysis.times')}</span>
            </div>
          )
        })}
      </div>
