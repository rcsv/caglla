...
function calculateActivityStats(trip: Trip): ActivityStats {
	...
	const secondaryCounts = new Map<
		string,
		{ primary: PrimaryCategoryType; count: number }
	>();
...
export default function ActivityStatsDisplay({
	trip,
}: ActivityStatsDisplayProps) {
	...
	const sortedPrimaryCategories = Object.entries(stats.primaryCategories).sort(
	...
	return (
		<div className="bg-white rounded-lg border border-gray-200 p-6">
			...
			<div className="mb-6 text-center">
				...
				<p className="text-sm text-gray-500">{t("activity.analysis.total")}</p>
			</div>
					...
					return (
						...
						>
							<span className="text-gray-600">
								{getSecondaryCategoryLabel(
									primary as PrimaryCategoryType,
									secondary,
								)}
							</span>
