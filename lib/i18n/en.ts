...
const en: Dictionary = {
	...
	"checklist.items.flight_international_rule.passport_validity.longDescription": `Generally, passports must have **at least 6 months** of validity remaining.

## Exceptions

Some exceptions apply in the following cases:

- When countries have agreements (e.g., Japan and the United States)
- When specific visas are obtained
- For short-term stays (usually within 30 days)

## How to Check

- Verify your passport expiration date
- Calculate if 6+ months remain from your departure date
- Check the latest information on the embassy/consulate website of your destination

For details, refer to the [Ministry of Foreign Affairs Overseas Safety Information](https://www.anzen.mofa.go.jp/).`,
	...
	"checklist.items.check_in_rule.hotel_confirmation_print.longDescription": `**Why is it needed?**  
Some hotels may require a paper copy even if digital presentation is accepted.  
Especially abroad, poor connectivity may prevent opening your phone screen, so having a paper copy is reassuring.`,
	...
	"checklist.items.check_in_rule.passport_copy.longDescription": `While many hotels require the original passport, some allow check-in with a copy.  
Useful during your stay when you don't want to carry the original.`,
	...
	"checklist.items.check_in_rule.cash_deposit.longDescription": `Overseas hotels may require a deposit (security deposit).  
Most accept credit cards, but **some small hotels only accept cash**.`,
	...
	"checklist.items.check_in_rule.underwear_days.longDescription": `Adjust the quantity according to the length of your trip.  
Those who want to reduce luggage can also choose to do laundry during the trip.`,
	...
	"checklist.items.check_in_rule.socks_days.longDescription": `For trips with lots of walking, treat **socks as consumables**.  
It's reassuring to bring extras.`,
	...
	"checklist.items.check_in_rule.shampoo_body_soap.longDescription": `While hotel amenities are increasingly common,  
some may have **scents that don't suit you** or **irritate your skin**.  
Those who are particular may want to bring their usual products.`,
	...
	"checklist.items.check_in_rule.toothbrush_toothpaste.longDescription": `Especially in Western countries, hotels often don't provide toothbrushes.  
It's reassuring to bring your usual products.`,
	...
	"checklist.items.check_in_rule.portable_detergent.longDescription": `Convenient for long trips or when prioritizing lightness.  
Choose **hand-wash gel or sheet types** to avoid increasing luggage.`,
...
Rope types are lightweight and easy to use in any room.`,
	...
	"checklist.items.check_out_rule.forgotten_items_check.longDescription": `Top 3 places where items are often forgotten at checkout.  
- **Safe**: Passport, cash  
- **Bathroom**: Toiletries  
- **Drawer**: Charger, medicine  
One final walk-through can make a big difference in peace of mind.`,
	...
	"checklist.items.check_out_rule.minibar_check.longDescription": `Minibars are expensive, and you're charged for what you consume at checkout.  
Check the contents to prevent billing errors.`,
	"checklist.items.camping_rule.tent.title": "Tent",
	"checklist.items.camping_rule.tent.description": "If campsite has no facilities",
	"checklist.items.camping_rule.tent.longDescription": `Essential equipment for accommodation.  
**Ease of setup** and **weather resistance** are key points.`,
	...
	"checklist.items.camping_rule.sleeping_bag.longDescription": `An item whose comfort varies greatly depending on nighttime temperature.  
Choose based on "comfort temperature" and "limit temperature" ratings.`,
	...
	"checklist.items.camping_rule.mat_airmat.longDescription": `Sleeping directly on the ground causes body heat loss and poor sleep.  
Choose mats based on **insulation performance (R-value)**.`,
	...
	"checklist.items.camping_rule.flashlight_headlamp.longDescription": `Essential for nighttime movement and cooking.  
Headlamps that free both hands are especially convenient.`,
	...
	"checklist.items.camping_rule.bbq_stove.longDescription": `Some campsites may restrict fire use.  
Check the rules in advance.`,
	...
	"checklist.items.camping_rule.tableware_cutlery.longDescription": `Choose from lightweight titanium or resin options depending on use.  
Disposable is an option when you want to save washing time or reduce return luggage.`,
	...
	"checklist.items.camping_rule.insect_repellent.longDescription": `Encountering insects in nature is unavoidable.  
Choose types with less skin irritation for safe use.`,
	...
	"checklist.items.camping_rule.first_aid_kit.longDescription": `Camping involves nature, so minor injuries are common.  
Keep band-aids, disinfectant, and gauze compactly organized for peace of mind.`,
	...
	"checklist.items.spa_rule.swimsuit_for_spa.longDescription": "Depending on bath and shower rules, a swimming cap may be required.",
	"checklist.items.spa_rule.sandals.title": "Sandals",
	"checklist.items.spa_rule.sandals.description": "For movement within the spa",
	"checklist.items.spa_rule.sandals.longDescription": "Bring sandals convenient for movement within the spa.",
