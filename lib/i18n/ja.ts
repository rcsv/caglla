...
const ja: Dictionary = {
	...
	"privacy.preface.content":
		"Caglla Travel Manager（以下「当サービス」）は、ユーザーの個人情報の保護を重要な責務と考え、以下のプライバシーポリシーを定めています。ユーザーは、本プライバシーポリシーに従って当サービスを利用することにより、個人情報の保護についての同意を与えることになります。",
	...
	"privacy.contact.content":
		'プライバシーポリシーに関するご質問は、<a href="/contact">お問い合わせページ</a>からご連絡ください。',
	// Features page
	...
	"contact.info.responseTime":
		"通常のお問い合わせには2-3営業日以内に回答いたします。複雑な問題については、回答までにお時間をいただく場合があります。",
	...
	"terms.s1.p1":
		"本規約は Caglla Travel Manager の利用条件を定めるものです。ご利用前にご確認ください。",
	...
	"terms.s5.p1":
		"故意または重過失を除き、当サービスの利用により生じた損害について一切の責任を負いません。中断・停止・終了による損害も同様です。",
	"terms.s6.title": "6. 規約の変更",
	"terms.s6.p1":
		"必要に応じて本規約を変更することがあります。変更後の規約は掲示時点で効力を生じます。",
	...
	"docs.cta.subtitle":
		"サポートまたはFAQをご確認ください。必要ならお問い合わせください。",
	...
	"home.mainTabs.friends": "友人の旅",
	"home.mainTabs.friends.description": "フォロー中のユーザーがシェアした旅やプランを時系列で追跡",
	"home.mainTabs.ideas": "旅のアイデア",
	"home.mainTabs.ideas.description": "旅行プランナーのテンプレートをカタログ感覚で探索",
	"home.mainTabs.shares": "自分のシェア",
	"home.mainTabs.shares.description": "公開範囲や期限を含めた自分のシェア旅を管理",
	"home.mainTabs.searchPlaceholder.friends": "フォロー中の旅やハッシュタグを検索",
	"home.mainTabs.searchPlaceholder.ideas": "都市名・テーマ・日数などで検索",
	"home.mainTabs.searchPlaceholder.shares": "公開済みの旅をタイトル・都市で検索",
	"home.mainTabs.filterChips.friends.all": "すべて",
	"home.mainTabs.filterChips.friends.active": "今旅行中",
	"home.mainTabs.filterChips.friends.recent": "最近公開",
	"home.mainTabs.filterChips.friends.templates": "テンプレのみ",
	"home.mainTabs.filterChips.ideas.area": "エリア: 日本",
	"home.mainTabs.filterChips.ideas.duration": "日数: 3-4日",
	"home.mainTabs.filterChips.ideas.budget": "予算: ¥¥",
	"home.mainTabs.filterChips.ideas.theme": "テーマ: 食",
	"home.mainTabs.filterChips.shares.public": "公開中",
	"home.mainTabs.filterChips.shares.expires": "期限あり",
	"home.mainTabs.filterChips.shares.followers": "フォロワー限定",
	"home.mainTabs.relativeTime.justNow": "たった今",
	"home.mainTabs.relativeTime.minutesAgo": "{minutes}分前",
	"home.mainTabs.relativeTime.hoursAgo": "{hours}時間前",
	"home.mainTabs.relativeTime.yesterday": "昨日",
	"home.mainTabs.relativeTime.daysAgo": "{days}日前",
	"home.mainTabs.error": "エラーが発生しました: {message}",
	"home.mainTabs.friends.empty": "フォロー中のユーザーの旅行はまだありません。",
	"home.mainTabs.friends.noResults": "検索結果が見つかりませんでした。",
	"home.mainTabs.ideas.empty": "公開されているテンプレートはまだありません。",
	"home.mainTabs.ideas.noResults": "検索結果が見つかりませんでした。",
	"home.mainTabs.shares.empty": "You haven't shared any trips yet.",
	"home.mainTabs.shares.noResults": "検索結果が見つかりませんでした。",
	"home.mainTabs.action.templatePublished": "テンプレートプランを公開",
	"home.mainTabs.action.tripShared": "旅行をシェアしました",
	"home.mainTabs.typeLabel.template": "PLAN TEMPLATE",
	"home.mainTabs.typeLabel.shared": "SHARED TRIP",
	"home.mainTabs.viewTrip": "旅を見る",
	"home.mainTabs.duplicatePlan": "プランを複製",
	"home.mainTabs.editShareSettings": "公開設定を編集",
	"home.mainTabs.visibility.follower": "フォロワーまで",
	"home.mainTabs.visibility.public": "全体公開",
	"home.mainTabs.visibility.linkOnly": "リンク限定",
	"home.mainTabs.expires.until": "{date}まで公開",
	"home.mainTabs.expires.noLimit": "期限なし",
	"home.mainTabs.expires.autoHide": "{date}で自動非公開",
	"home.mainTabs.updated": "更新: {date}",
	"home.guides.title": "執筆中の Guide",
	"home.guides.viewAll": "すべて見る",
	"home.guides.empty": "執筆中の Guide はありません",
	"home.guides.updated": "更新: {date}",
	...
	"profile.setupBanner.description":
		"あなたについて教えてください。他のユーザーとつながりやすくなります。",
	"profile.name": "名前",
	"profile.bio": "自己紹介",
	...
	"ical.about.li1":
		"Google Calendar、Apple Calendar等のカレンダーアプリに取り込めます",
	...
	"ical.addToCalendar.google":
		"Google Calendar: 「他のカレンダー」→「URLで追加」→ URLを貼り付け",
	"ical.addToCalendar.apple":
		"Apple Calendar: 「ファイル」→「新規カレンダー照会」→ URLを貼り付け",
	"ical.addToCalendar.outlook":
		"Outlook: 「カレンダー追加」→「インターネットから」→ URLを貼り付け",
	"ical.disabled": "iCal公開が無効です",
	"ical.enabling": "有効化中...",
	"ical.enable": "iCal公開を有効化",
	"ical.enableError": "iCal公開の有効化に失敗しました",
	"ical.disableConfirm":
		"iCal公開を無効にしますか？外部カレンダーアプリからアクセスできなくなります。",
	...
	"dayEditor.deleteConfirmWithItineraries":
		"この日には予定が含まれています。削除するとすべての予定も削除されます。よろしいですか？",
	...
	"distance.openTransitUnavailable":
		"場所情報が不足しているためTransitリンクは利用できません",
	// Navigation
	"nav.summary": "概要",
	"nav.itinerary": "日程",
	...
	"export.description.trip.json":
		"旅程全体のデータ（旅行情報、日程、Itinerary、予約情報）をJSON形式でエクスポートします。",
	"export.description.trip.csv":
		"旅程全体のItinerary一覧をCSV形式でエクスポートします。Excel等で編集可能です。",
	"export.description.trip.ical":
		"旅程全体のItineraryをiCalendar形式でエクスポートします。Google Calendar、Apple Calendar等に取り込めます。",
	"export.description.reservation.json":
		"予約情報のみをJSON形式でエクスポートします。",
	"export.description.reservation.csv":
		"予約情報のみをCSV形式でエクスポートします。Excel等で編集可能です。",
	"export.description.reservation.ical":
		"予約情報のみをiCalendar形式でエクスポートします。カレンダーアプリに取り込んで予定管理・通知設定ができます。",
	// Subscription Modal
	...
	"routeCost.waypoints":
		"{waypointCount}地点 → {requestsNeeded}回のAPI呼び出し",
	// Trip Itinerary View
	...
	"weather.constraint.remainingDays":
		"旅行期間の残り{remainingDays}日分は表示されていません。",
	...
	"trip.template.replicateDayCountSummary":
		"このテンプレートは {{dayCount}} 日構成です。終了日は自動で入力されます。",
	"trip.template.replicateEndDatePreview":
		"終了日は自動的に {{endDate}} に設定されます。",
	...
	"trip.publish.unpublishConfirmMessage":
		"この旅行を非公開にすると、他のユーザーが閲覧できなくなります。",
	...
	"trip.create.validation.destinationRequired":
		"目的地を選択してください。Google Placesから場所を検索して選択してください。",
	...
	"checklist.printUrl.title": "旅のしおりの印刷用URL",
	"checklist.printUrl.description": "印刷プレビューでPDF化できます",
	"checklist.printUrl.linkLabel": "印刷プレビューを開く",
	"checklist.delete": "削除",
	...
	"checklist.priority.high": "高",
	"checklist.priority.medium": "中",
	...
	"checklist.unknownCategory": "不明なカテゴリー",
	"checklist.categoryProgress": "カテゴリ内の進捗",
	...
	"checklist.items.flight_international_rule.passport_validity.title": "パスポートの有効期限確認（6ヶ月以上残存）",
	"checklist.items.flight_international_rule.passport_validity.description": "多くの国で入国時に6ヶ月以上の残存期間が必要",
	"checklist.items.flight_international_rule.passport_validity.longDescription": `一般的に、パスポートの残存期間は**6ヶ月以上**あることが求められます。
...
詳細は[外務省の海外安全情報](https://www.anzen.mofa.go.jp/)を参照してください。`,
	"checklist.items.flight_international_rule.flight_ticket.title": "航空券の印刷またはモバイルチケット準備",
	"checklist.items.flight_international_rule.flight_ticket.description": "Eチケット控えまたはアプリでの搭乗券",
	"checklist.items.flight_international_rule.online_checkin.title": "オンラインチェックイン（24時間前）",
	"checklist.items.flight_international_rule.online_checkin.description": "座席指定や搭乗時間の短縮に",
	"checklist.items.flight_international_rule.esta_application.title": "ESTA申請（アメリカ入国）",
	"checklist.items.flight_international_rule.esta_application.description": "渡航72時間前までに申請推奨、有効期限2年",
	"checklist.items.flight_international_rule.eta_application.title": "eTA申請（カナダ入国）",
	"checklist.items.flight_international_rule.eta_application.description": "カナダへの空路入国に必要",
	"checklist.items.flight_international_rule.etias_application.title": "ETIAS申請（EU入国）",
	"checklist.items.flight_international_rule.etias_application.description": "2025年からEU圏入国に必要（予定）",
	"checklist.items.flight_international_rule.travel_insurance.title": "海外旅行保険加入",
	"checklist.items.flight_international_rule.travel_insurance.description": "医療費が高額な国では必須",
	"checklist.items.flight_international_rule.neck_pillow.title": "ネックピロー",
	"checklist.items.flight_international_rule.neck_pillow.description": "長時間フライトの快適性向上",
	"checklist.items.flight_international_rule.earplugs_eyemask.title": "耳栓・アイマスク",
	"checklist.items.flight_international_rule.earplugs_eyemask.description": "機内での睡眠サポート",
	"checklist.items.car_rental_rule.international_driving_license.title": "国際運転免許証の取得",
	"checklist.items.car_rental_rule.international_driving_license.description": "海外でレンタカーを借りる場合に必要",
	"checklist.items.car_rental_rule.rental_confirmation.title": "レンタカー予約確認書の印刷",
	"checklist.items.car_rental_rule.rental_confirmation.description": "貸出時に提示が必要",
	"checklist.items.car_rental_rule.credit_card_deposit.title": "クレジットカード（デポジット用）",
	"checklist.items.car_rental_rule.credit_card_deposit.description": "レンタカーのデポジットに使用",
	"checklist.items.car_rental_rule.navigation_device.title": "カーナビまたはスマホホルダー",
	"checklist.items.car_rental_rule.navigation_device.description": "ナビゲーション用",
	"checklist.items.personal_car_rule.car_inspection_insurance.title": "車検証・自賠責保険証の確認",
	"checklist.items.personal_car_rule.car_inspection_insurance.description": "有効期限や携行の必要書類をチェック",
	"checklist.items.personal_car_rule.fuel_charge.title": "ガソリン補給または充電",
	"checklist.items.personal_car_rule.fuel_charge.description": "長距離運転前に給油・充電を済ませる",
	"checklist.items.personal_car_rule.etc_card.title": "ETCカード・高速料金の準備",
	"checklist.items.personal_car_rule.etc_card.description": "高速道路利用時の支払い手段を用意",
	"checklist.items.parking_rule.parking_reservation.title": "駐車場の事前予約確認",
	"checklist.items.parking_rule.parking_reservation.description": "予約番号・入庫可能時間を確認",
	"checklist.items.parking_rule.parking_payment.title": "精算方法の準備（現金・アプリ）",
	"checklist.items.parking_rule.parking_payment.description": "現地の支払い方法に合わせて準備",
	"checklist.items.parking_rule.parking_location_memo.title": "駐車位置メモ用のノート／アプリ",
	"checklist.items.parking_rule.parking_location_memo.description": "駐車フロアや番号を記録できるようにする",
	"checklist.items.breakfast_rule.hotel_breakfast_plan.title": "ホテルの朝食プランの確認",
	"checklist.items.breakfast_rule.hotel_breakfast_plan.description": "朝食込みプランか、別料金か確認",
	"checklist.items.breakfast_rule.nearby_cafe_restaurant.title": "周辺のカフェ・レストラン検索",
	"checklist.items.breakfast_rule.nearby_cafe_restaurant.description": "ホテル朝食がない場合の代替案",
	"checklist.items.lunch_rule.restaurant_reservation.title": "レストラン予約（人気店の場合）",
	"checklist.items.lunch_rule.restaurant_reservation.description": "混雑時間帯を避けるため",
	"checklist.items.lunch_rule.allergy_translation.title": "アレルギー情報の翻訳メモ",
	"checklist.items.lunch_rule.allergy_translation.description": "食物アレルギーがある場合",
	"checklist.items.dinner_rule.restaurant_reservation_required.title": "レストラン予約（必須）",
	"checklist.items.dinner_rule.restaurant_reservation_required.description": "人気レストランは1週間前までに予約",
	"checklist.items.dinner_rule.dress_code_check.title": "ドレスコード確認",
	"checklist.items.dinner_rule.dress_code_check.description": "高級レストランの場合",
	"checklist.items.dinner_rule.formal_attire.title": "フォーマルな服装",
	"checklist.items.dinner_rule.formal_attire.description": "ドレスコードがある場合",
	"checklist.items.cafe_rule.popular_cafe_hours.title": "人気カフェの営業時間確認",
	"checklist.items.cafe_rule.popular_cafe_hours.description": "定休日や営業時間を事前確認",
	"checklist.items.cafe_rule.camera_smartphone.title": "カメラ・スマホ（SNS投稿用）",
	"checklist.items.cafe_rule.camera_smartphone.description": "インスタ映えするカフェの場合",
	"checklist.items.bar_rule.bar_reservation.title": "バーの予約（高級バーの場合）",
	"checklist.items.bar_rule.bar_reservation.description": "人気バーは予約推奨",
	"checklist.items.bar_rule.dress_code_check.title": "ドレスコード確認",
	"checklist.items.bar_rule.dress_code_check.description": "カジュアルすぎる服装はNG",
	"checklist.items.bar_rule.cash_for_tips.title": "現金（チップ用）",
	"checklist.items.bar_rule.cash_for_tips.description": "バーテンダーへのチップ",
	"checklist.items.food_tour_rule.food_tour_reservation.title": "フードツアーの予約",
	"checklist.items.food_tour_rule.food_tour_reservation.description": "人気ツアーは早めの予約が必要",
	"checklist.items.food_tour_rule.empty_stomach.title": "空腹状態で参加",
	"checklist.items.food_tour_rule.empty_stomach.description": "多くの店舗を回るため",
	"checklist.items.food_tour_rule.comfortable_shoes.title": "歩きやすい靴",
	"checklist.items.food_tour_rule.comfortable_shoes.description": "長時間歩くことが多い",
	"checklist.items.food_tour_rule.eco_bag.title": "エコバッグ",
	"checklist.items.food_tour_rule.eco_bag.description": "お土産を入れるのに便利",
	"checklist.items.street_food_rule.hygienic_stall_research.title": "衛生的な屋台の見分け方を調査",
	"checklist.items.street_food_rule.hygienic_stall_research.description": "食中毒リスクを減らす",
	"checklist.items.street_food_rule.cash_change.title": "現金（小銭）",
	"checklist.items.street_food_rule.cash_change.description": "屋台はカード不可がほとんど",
	"checklist.items.street_food_rule.wet_wipes.title": "ウェットティッシュ",
	"checklist.items.street_food_rule.wet_wipes.description": "手を拭くため",
	"checklist.items.street_food_rule.stomach_medicine.title": "胃腸薬",
	"checklist.items.street_food_rule.stomach_medicine.description": "万が一に備えて",
	"checklist.items.street_food_rule.plastic_bag.title": "ビニール袋",
	"checklist.items.street_food_rule.plastic_bag.description": "食べ終わったゴミを一時的にまとめる",
	"checklist.items.fine_dining_rule.restaurant_reservation_month.title": "レストラン予約（1ヶ月前）",
	"checklist.items.fine_dining_rule.restaurant_reservation_month.description": "有名店は数ヶ月前から予約が埋まる",
	"checklist.items.fine_dining_rule.dress_code_required.title": "ドレスコード確認（必須）",
	"checklist.items.fine_dining_rule.dress_code_required.description": "ジャケット、ネクタイが必要な場合も",
	"checklist.items.fine_dining_rule.menu_preview.title": "メニューの事前確認",
	"checklist.items.fine_dining_rule.menu_preview.description": "コース内容・価格を確認",
	"checklist.items.fine_dining_rule.formal_attire_jacket_tie.title": "フォーマルな服装（ジャケット・ネクタイ）",
	"checklist.items.fine_dining_rule.formal_attire_jacket_tie.description": "ドレスコードに応じた服装",
	"checklist.items.fine_dining_rule.leather_shoes_heels.title": "革靴・ヒール",
	"checklist.items.fine_dining_rule.leather_shoes_heels.description": "スニーカーはNG",
	"checklist.items.grocery_rule.supermarket_hours.title": "スーパーの営業時間確認",
	"checklist.items.grocery_rule.supermarket_hours.description": "日曜日は休みの国もある",
	"checklist.items.grocery_rule.eco_bag.title": "エコバッグ",
	"checklist.items.grocery_rule.eco_bag.description": "レジ袋が有料の国が多い",
	"checklist.items.grocery_rule.coin_purse.title": "小銭入れ",
	"checklist.items.grocery_rule.coin_purse.description": "コイン支払いが必要な場合",
	"checklist.items.local_market_rule.market_hours.title": "市場の営業日・時間確認",
	"checklist.items.local_market_rule.market_hours.description": "特定の曜日のみ開催の市場もある",
	"checklist.items.local_market_rule.bargaining_phrases.title": "値段交渉の基本フレーズを学習",
	"checklist.items.local_market_rule.bargaining_phrases.description": "現地の言葉で値引き交渉",
	"checklist.items.local_market_rule.cash_change.title": "現金（小銭）",
	"checklist.items.local_market_rule.cash_change.description": "市場はカード不可がほとんど",
	"checklist.items.local_market_rule.eco_bag_folding.title": "エコバッグ・折りたたみバッグ",
	"checklist.items.local_market_rule.eco_bag_folding.description": "購入品を入れるため",
	"checklist.items.local_market_rule.comfortable_shoes.title": "歩きやすい靴",
	"checklist.items.local_market_rule.comfortable_shoes.description": "市場内は長時間歩く",
	"checklist.items.duty_free_rule.passport_for_duty_free.title": "パスポート（購入時に提示が必要）",
	"checklist.items.duty_free_rule.passport_for_duty_free.description": "免税手続きに必須",
	"checklist.items.duty_free_rule.flight_confirmation.title": "航空券予約確認書",
	"checklist.items.duty_free_rule.flight_confirmation.description": "出国証明として必要な場合も",
	"checklist.items.duty_free_rule.duty_free_eligibility.title": "免税対象商品・金額の事前確認",
	"checklist.items.duty_free_rule.duty_free_eligibility.description": "国によって免税条件が異なる",
	"checklist.items.shopping_rule.eco_bag_folding.title": "エコバッグ・折りたたみバッグ",
	"checklist.items.shopping_rule.eco_bag_folding.description": "お土産を入れるのに便利",
	"checklist.items.shopping_rule.cash_souvenir_budget.title": "現金（お土産予算）",
	"checklist.items.shopping_rule.cash_souvenir_budget.description": "市場や小規模店舗ではカード不可の場合あり",
	"checklist.items.check_in_rule.hotel_confirmation_print.title": "ホテル予約確認書をプリントアウト",
	"checklist.items.check_in_rule.hotel_confirmation_print.description": "チェックイン時に提示が必要な場合があります",
	"checklist.items.check_in_rule.hotel_confirmation_print.longDescription": `**なぜ必要なのか？**  
一部のホテルでは、デジタル提示を認めていても「紙」の提出を求められるケースがあります。  
特に海外では、通信環境が悪くスマホ画面が開けない場面もあるため、紙で持っておくと安心です。`,
	"checklist.items.check_in_rule.passport_copy.title": "パスポートのコピー",
	"checklist.items.check_in_rule.passport_copy.description": "ホテルによっては原本の代わりに使用可能",
	"checklist.items.check_in_rule.passport_copy.longDescription": `パスポート原本の提示を求められることは多いですが、コピーでもチェックインが可能なホテルもあります。  
原本を持ち歩きたくない滞在中にも役立ちます。`,
	"checklist.items.check_in_rule.cash_deposit.title": "現金（デポジット用）",
	"checklist.items.check_in_rule.cash_deposit.description": "クレジットカードでも可",
	"checklist.items.check_in_rule.cash_deposit.longDescription": `海外のホテルでは「デポジット（保証金）」が必要な場合があります。  
クレジットカードで済むことがほとんどですが、**小規模ホテルでは現金しか受け付けない**ことも。`,
	"checklist.items.check_in_rule.underwear_days.title": "下着 × {count}日分",
	"checklist.items.check_in_rule.underwear_days.description": "宿泊日数分の下着を準備",
	"checklist.items.check_in_rule.underwear_days.longDescription": `旅行の日数に合わせて枚数を調整します。  
荷物を減らしたい人は、途中で洗濯するという選択肢もアリ。`,
	"checklist.items.check_in_rule.socks_days.title": "靴下 × {count}日分",
	"checklist.items.check_in_rule.socks_days.description": "宿泊日数分の靴下を準備",
	"checklist.items.check_in_rule.socks_days.longDescription": `観光で歩く機会が多い旅行では、**靴下は消耗品**として捉えましょう。  
予備も含めて多めに持っておくと安心。`,
	"checklist.items.check_in_rule.shampoo_body_soap.title": "シャンプー・ボディソープ",
	"checklist.items.check_in_rule.shampoo_body_soap.description": "ホテルのアメニティを確認",
	"checklist.items.check_in_rule.shampoo_body_soap.longDescription": `最近は備え付けのアメニティが増えていますが、  
**香りが合わない**・**肌に合わない**というケースもあります。  
気になる人は普段使いを携帯すると快適。`,
	"checklist.items.check_in_rule.toothbrush_toothpaste.title": "歯ブラシ・歯磨き粉",
	"checklist.items.check_in_rule.toothbrush_toothpaste.description": "アメニティにない場合があります",
	"checklist.items.check_in_rule.toothbrush_toothpaste.longDescription": `特に欧米では、ホテルに歯ブラシが置いていないことが一般的です。  
普段使いを持参しておくと安心です。`,
	"checklist.items.check_in_rule.portable_detergent.title": "洗濯用洗剤（携帯用）",
	"checklist.items.check_in_rule.portable_detergent.description": "長期滞在の場合に便利",
	"checklist.items.check_in_rule.portable_detergent.longDescription": `長期旅行や、身軽さを重視したい場合に便利。  
**手洗い用ジェルやシートタイプ**を選ぶと荷物が増えません。`,
	"checklist.items.check_in_rule.laundry_clips_rope.title": "洗濯バサミ・洗濯ロープ",
	"checklist.items.check_in_rule.laundry_clips_rope.description": "部屋干し用",
	"checklist.items.check_in_rule.laundry_clips_rope.longDescription": `ホテルには干す場所が限られていることがあります。  
ロープタイプは軽量で、どんな部屋でも使いやすいのが利点。`,
	"checklist.items.check_out_rule.forgotten_items_check.title": "忘れ物チェック（引き出し・金庫・浴室）",
	"checklist.items.check_out_rule.forgotten_items_check.description": "チェックアウト前に必ず確認",
	"checklist.items.check_out_rule.forgotten_items_check.longDescription": `チェックアウト時に忘れ物が発生しやすい場所トップ3。  
- **金庫**：パスポート・現金  
- **浴室**：洗面道具  
- **引き出し**：充電器・薬  
最後にもう一度ぐるっと見回すだけで安心度が大きく変わります。`,
	"checklist.items.check_out_rule.minibar_check.title": "冷蔵庫の飲食確認",
	"checklist.items.check_out_rule.minibar_check.description": "ミニバーの飲食は追加料金が発生",
	"checklist.items.check_out_rule.minibar_check.longDescription": `ミニバーは値段が高めで、飲んだ分だけチェックアウト時に精算されます。  
誤課金を防ぐためにも、中身を確認しておきましょう。`,
	"checklist.items.camping_rule.tent.title": "テント",
	"checklist.items.camping_rule.tent.description": "キャンプ場に設備がない場合",
	"checklist.items.camping_rule.tent.longDescription": `宿泊用の要となる装備。  
**設営しやすさ**と**耐候性**がポイントです。`,
	"checklist.items.camping_rule.sleeping_bag.title": "寝袋",
	"checklist.items.camping_rule.sleeping_bag.description": "気温に応じた寝袋を選択",
	"checklist.items.camping_rule.sleeping_bag.longDescription": `夜間の気温次第で快適性が大きく変わるアイテム。  
「快適温度」「限界温度」の表示を基準に選ぶと失敗しません。`,
	"checklist.items.camping_rule.mat_airmat.title": "マット・エアマット",
	"checklist.items.camping_rule.mat_airmat.description": "地面からの冷気対策",
	"checklist.items.camping_rule.mat_airmat.longDescription": `地面に直接寝ると、体温が奪われて寝付きが悪くなります。  
マットは**断熱性能（R値）**を目安に選ぶと良いです。`,
	"checklist.items.camping_rule.flashlight_headlamp.title": "懐中電灯・ヘッドライト",
	"checklist.items.camping_rule.flashlight_headlamp.description": "夜間の照明",
	"checklist.items.camping_rule.flashlight_headlamp.longDescription": `夜間の移動や調理に必須。  
両手が空くヘッドライトは特に便利です。`,
	"checklist.items.camping_rule.bbq_stove.title": "バーベキューコンロ・ガスバーナー",
	"checklist.items.camping_rule.bbq_stove.description": "調理器具（キャンプ場規定確認）",
	"checklist.items.camping_rule.bbq_stove.longDescription": `キャンプ場によっては火器の使用が制限される場合があります。  
事前にルールを確認しておきましょう。`,
	"checklist.items.camping_rule.tableware_cutlery.title": "食器・カトラリー",
	"checklist.items.camping_rule.tableware_cutlery.description": "使い捨てまたは洗えるもの",
	"checklist.items.camping_rule.tableware_cutlery.longDescription": `軽量のチタン製や樹脂製など、用途に応じて選択できます。  
洗う手間を省きたい、帰りの荷物を小さくしたいというときは、使い捨てもアリ。`,
	"checklist.items.camping_rule.insect_repellent.title": "虫除けスプレー",
	"checklist.items.camping_rule.insect_repellent.description": "蚊・虫対策",
	"checklist.items.camping_rule.insect_repellent.longDescription": `自然の中では虫との遭遇は避けられません。  
肌への刺激が少ないタイプを選ぶと安心して使えます。`,
	"checklist.items.camping_rule.first_aid_kit.title": "救急セット",
	"checklist.items.camping_rule.first_aid_kit.description": "擦り傷・火傷用の応急処置",
	"checklist.items.camping_rule.first_aid_kit.longDescription": `キャンプは自然相手なので、小さなケガは起こりがち。  
バンドエイド・消毒液・ガーゼなどをコンパクトにまとめておくと安心。`,
	"checklist.items.hiking_rule.trekking_shoes.title": "トレッキングシューズ",
	"checklist.items.hiking_rule.trekking_shoes.description": "登山道に適した靴",
	"checklist.items.hiking_rule.rainwear.title": "レインウェア",
	"checklist.items.hiking_rule.rainwear.description": "山の天気は変わりやすい",
	"checklist.items.hiking_rule.hat_sunglasses.title": "帽子・サングラス",
	"checklist.items.hiking_rule.hat_sunglasses.description": "日差し対策",
	"checklist.items.hiking_rule.water_bottle_hydration.title": "水筒・ハイドレーション",
	"checklist.items.hiking_rule.water_bottle_hydration.description": "十分な水分補給",
	"checklist.items.hiking_rule.trail_food_energy_bar.title": "行動食・エネルギーバー",
	"checklist.items.hiking_rule.trail_food_energy_bar.description": "トレイル中のエネルギー補給",
	"checklist.items.hiking_rule.first_aid_kit.title": "ファーストエイドキット",
	"checklist.items.hiking_rule.first_aid_kit.description": "応急処置用",
	"checklist.items.water_sports_rule.swimsuit.title": "水着",
	"checklist.items.water_sports_rule.swimsuit.description": "ビーチやマリンスポーツ用",
	"checklist.items.water_sports_rule.rash_guard.title": "ラッシュガード",
	"checklist.items.water_sports_rule.rash_guard.description": "日焼け・擦り傷防止",
	"checklist.items.water_sports_rule.beach_towel.title": "ビーチタオル",
	"checklist.items.water_sports_rule.beach_towel.description": "プールやビーチで使用",
	"checklist.items.water_sports_rule.sunscreen_spf50.title": "日焼け止め（SPF50+）",
	"checklist.items.water_sports_rule.sunscreen_spf50.description": "強い紫外線から肌を守る",
	"checklist.items.water_sports_rule.waterproof_phone_case.title": "防水スマホケース",
	"checklist.items.water_sports_rule.waterproof_phone_case.description": "水辺での撮影に便利",
	"checklist.items.water_sports_rule.goggles_snorkel_set.title": "ゴーグル・シュノーケルセット",
	"checklist.items.water_sports_rule.goggles_snorkel_set.description": "レンタルがない場合に持参",
	"checklist.items.diving_rule.diving_license_card.title": "ダイビングライセンスカード",
	"checklist.items.diving_rule.diving_license_card.description": "Cカードの携帯必須",
	"checklist.items.diving_rule.logbook.title": "ログブック",
	"checklist.items.diving_rule.logbook.description": "ダイビング履歴の記録",
	"checklist.items.diving_rule.underwater_camera.title": "水中カメラ・GoPro",
	"checklist.items.diving_rule.underwater_camera.description": "水中撮影用",
	"checklist.items.currency_exchange_rule.cash_for_exchange.title": "両替する現金の準備",
	"checklist.items.currency_exchange_rule.cash_for_exchange.description": "目的地の通貨レートを確認",
	"checklist.items.currency_exchange_rule.passport_for_exchange.title": "パスポート（両替時に提示が必要な場合あり）",
	"checklist.items.currency_exchange_rule.passport_for_exchange.description": "大金の両替では本人確認が必要",
	"checklist.items.sim_purchase_rule.sim_free_smartphone.title": "SIMフリースマートフォン",
	"checklist.items.sim_purchase_rule.sim_free_smartphone.description": "SIMロックがかかっていないか確認",
	"checklist.items.sim_purchase_rule.passport_for_sim.title": "パスポート（購入時に提示が必要）",
	"checklist.items.sim_purchase_rule.passport_for_sim.description": "SIM購入には本人確認が必要",
	"checklist.items.long_stay_rule.common_medicines.title": "常備薬（風邪薬、胃腸薬、頭痛薬）",
	"checklist.items.long_stay_rule.common_medicines.description": "海外で薬を購入するのは困難",
	"checklist.items.long_stay_rule.multivitamin.title": "マルチビタミン",
	"checklist.items.long_stay_rule.multivitamin.description": "食生活の変化で栄養バランスが崩れがち",
	"checklist.items.long_stay_rule.folding_umbrella.title": "折りたたみ傘",
	"checklist.items.long_stay_rule.folding_umbrella.description": "急な天候変化に対応",
	"checklist.items.long_stay_rule.charger_mobile_battery.title": "充電器・モバイルバッテリー",
	"checklist.items.long_stay_rule.charger_mobile_battery.description": "長期滞在では必須",
	"checklist.items.long_stay_rule.adapter_plug.title": "変換プラグ",
	"checklist.items.long_stay_rule.adapter_plug.description": "目的地のコンセント形状を確認",
	"checklist.items.train_rule.rail_pass_ticket.title": "鉄道パスまたは乗車券の事前購入",
	"checklist.items.train_rule.rail_pass_ticket.description": "乗車日前に購入すると割引がある場合も",
	"checklist.items.train_rule.route_map_app.title": "路線図・乗り換えアプリのダウンロード",
	"checklist.items.train_rule.route_map_app.description": "Google Maps、乗換案内など",
	"checklist.items.train_rule.ic_card.title": "ICカード（Suica、Pasmoなど）",
	"checklist.items.train_rule.ic_card.description": "日本国内での移動に便利",
	"checklist.items.bus_rule.bus_ticket_reservation.title": "バスチケット予約確認",
	"checklist.items.bus_rule.bus_ticket_reservation.description": "高速バスは予約が必要な場合が多い",
	"checklist.items.bus_rule.bus_location_time.title": "乗車場所・時刻の事前確認",
	"checklist.items.bus_rule.bus_location_time.description": "バスターミナルの場所を事前に調べる",
	"checklist.items.bus_rule.neck_pillow_blanket.title": "ネックピロー・ブランケット",
	"checklist.items.bus_rule.neck_pillow_blanket.description": "長距離バスの場合",
	"checklist.items.taxi_rule.taxi_app_install.title": "タクシー配車アプリのインストール",
	"checklist.items.taxi_rule.taxi_app_install.description": "Uber、Grab、DiDiなど",
	"checklist.items.taxi_rule.destination_address_memo.title": "目的地の住所をメモ",
	"checklist.items.taxi_rule.destination_address_memo.description": "言葉が通じない場合に備えて",
	"checklist.items.taxi_rule.cash_change.title": "現金（小銭）",
	"checklist.items.taxi_rule.cash_change.description": "クレジットカードが使えないタクシーもある",
	"checklist.items.ferry_rule.ferry_ticket_reservation.title": "フェリーチケット予約",
	"checklist.items.ferry_rule.ferry_ticket_reservation.description": "人気路線は早めの予約が必要",
	"checklist.items.ferry_rule.boarding_time_location.title": "乗船時刻・乗り場の確認",
	"checklist.items.ferry_rule.boarding_time_location.description": "出港時刻の30分前には到着",
	"checklist.items.ferry_rule.motion_sickness_medicine.title": "酔い止め薬",
	"checklist.items.ferry_rule.motion_sickness_medicine.description": "船酔いしやすい人は必須",
	"checklist.items.ferry_rule.warm_clothing.title": "防寒具・上着",
	"checklist.items.ferry_rule.warm_clothing.description": "海上は寒いことが多い",
	"checklist.items.beach_rule.swimsuit.title": "水着",
	"checklist.items.beach_rule.swimsuit.description": "ビーチで泳ぐ場合",
	"checklist.items.beach_rule.sandals_beach_sandals.title": "サンダル・ビーチサンダル",
	"checklist.items.beach_rule.sandals_beach_sandals.description": "ビーチ用の履物",
	"checklist.items.beach_rule.sunscreen.title": "日焼け止め",
	"checklist.items.beach_rule.sunscreen.description": "SPF50+推奨",
	"checklist.items.beach_rule.sunglasses.title": "サングラス",
	"checklist.items.beach_rule.sunglasses.description": "紫外線から目を守る",
	"checklist.items.beach_rule.beach_bag.title": "ビーチバッグ",
	"checklist.items.beach_rule.beach_bag.description": "荷物を砂から守る",
	"checklist.items.aquarium_rule.camera_smartphone.title": "カメラ・スマホ",
	"checklist.items.aquarium_rule.camera_smartphone.description": "海洋生物の撮影用",
	"checklist.items.aquarium_rule.binoculars.title": "双眼鏡",
	"checklist.items.aquarium_rule.binoculars.description": "遠くの生物観察に便利",
	"checklist.items.aquarium_rule.waterproof_case.title": "防水ケース",
	"checklist.items.aquarium_rule.waterproof_case.description": "水槽近くでの撮影用",
	"checklist.items.temple_shrine_rule.long_pants_skirt.title": "長ズボンまたはロングスカート",
	"checklist.items.temple_shrine_rule.long_pants_skirt.description": "寺院・モスクでは肌の露出を控える",
	"checklist.items.temple_shrine_rule.stole_scarf.title": "ストール・スカーフ",
	"checklist.items.temple_shrine_rule.stole_scarf.description": "頭を覆う必要がある場合に",
	"checklist.items.spa_rule.swimsuit_for_spa.title": "水着（スパによっては必要）",
	"checklist.items.spa_rule.swimsuit_for_spa.description": "スパの規定を確認",
	"checklist.items.spa_rule.swimsuit_for_spa.longDescription": "バスやシャワーでのルールによっては、水泳帽が必要な場合があります。",
	"checklist.items.spa_rule.sandals.title": "サンダル",
	"checklist.items.spa_rule.sandals.description": "スパ内での移動用",
	"checklist.items.spa_rule.sandals.longDescription": "スパ内での移動に便利なサンダルを持ち込みましょう。",
	"checklist.items.city_walk_rule.walking_route_check.title": "街歩きルートの事前確認",
	"checklist.items.city_walk_rule.walking_route_check.description": "見どころを効率的に回るルートを計画",
	"checklist.items.city_walk_rule.offline_map_download.title": "オフラインマップのダウンロード",
	"checklist.items.city_walk_rule.offline_map_download.description": "Google Maps、Maps.meなど",
	"checklist.items.city_walk_rule.comfortable_shoes.title": "歩きやすい靴",
	"checklist.items.city_walk_rule.comfortable_shoes.description": "長時間歩くため必須",
	"checklist.items.city_walk_rule.water_bottle.title": "水筒・ペットボトル",
	"checklist.items.city_walk_rule.water_bottle.description": "水分補給用",
	"checklist.items.city_walk_rule.mobile_battery.title": "モバイルバッテリー",
	"checklist.items.city_walk_rule.mobile_battery.description": "スマホのバッテリー切れ対策",
	"checklist.items.photography_rule.no_photo_area_check.title": "撮影禁止エリアの事前確認",
	"checklist.items.photography_rule.no_photo_area_check.description": "寺院や美術館では撮影禁止の場合も",
	"checklist.items.photography_rule.sunrise_sunset_time.title": "サンライズ・サンセット時刻の確認",
	"checklist.items.photography_rule.sunrise_sunset_time.description": "ゴールデンアワーの撮影計画",
	"checklist.items.photography_rule.camera_lens.title": "カメラ・レンズ",
	"checklist.items.photography_rule.camera_lens.description": "用途に応じたレンズを持参",
	"checklist.items.photography_rule.spare_battery_charger.title": "予備バッテリー・充電器",
	"checklist.items.photography_rule.spare_battery_charger.description": "長時間撮影に備えて",
	"checklist.items.photography_rule.sd_cards.title": "SDカード（複数枚）",
	"checklist.items.photography_rule.sd_cards.description": "容量不足に備えて",
	"checklist.items.photography_rule.tripod_mini_tripod.title": "三脚・ミニ三脚",
	"checklist.items.photography_rule.tripod_mini_tripod.description": "夜景や長時間露光撮影用",
	"checklist.items.nature_walk_rule.weather_forecast.title": "天気予報の確認",
	"checklist.items.nature_walk_rule.weather_forecast.description": "雨天時の対策を検討",
	"checklist.items.nature_walk_rule.trail_map_download.title": "トレイルマップのダウンロード",
	"checklist.items.nature_walk_rule.trail_map_download.description": "オフラインで閲覧可能なマップ",
	"checklist.items.nature_walk_rule.trekking_shoes.title": "トレッキングシューズ",
	"checklist.items.nature_walk_rule.trekking_shoes.description": "自然散策に適した靴",
	"checklist.items.nature_walk_rule.rainwear.title": "レインウェア",
	"checklist.items.nature_walk_rule.rainwear.description": "急な天候変化に備えて",
	"checklist.items.nature_walk_rule.insect_repellent.title": "虫除けスプレー",
	"checklist.items.nature_walk_rule.insect_repellent.description": "蚊・虫対策",
	...
	"reservation.validation.airportCode":
		"空港コードは3文字の英大文字で入力してください（例: NRT, HND）",
	"reservation.validation.flightNumber":
		"便名は航空会社コード+数字の形式で入力してください（例: ANA123, JAL456）",
	...
	"userSettings.description.unitSystem":
		"選択した単位系に応じて、温度と距離の単位が自動的に設定されます",
