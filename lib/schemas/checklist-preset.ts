 ...
 */
const ChecklistPresetItemSchema = z.object({
...
export const CreateChecklistPresetSchema = z.object({
  ...
  items: z.array(ChecklistPresetItemSchema).min(1, 'At least one item is required'),
 ...
 * 型推論
 */
export type CreateChecklistPresetInput = z.infer<typeof CreateChecklistPresetSchema>
export type UpdateChecklistPresetInput = z.infer<typeof UpdateChecklistPresetSchema>
