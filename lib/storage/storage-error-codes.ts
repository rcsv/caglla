 ...
 * @returns i18n翻訳キー
 */
export function getStorageErrorI18nKey(
	...
	const mapping: Record<StorageErrorCode, TranslationKey> = {
		...
		[StorageErrorCode.STORAGE_INVALID_FORMAT]:
