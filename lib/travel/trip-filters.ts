 ...
 * ```
 */
export function filterOngoingTrips(trips: Trip[], referenceDate?: Date): Trip[] {
 ...
 * ```
 */
export function filterUpcomingTrips(trips: Trip[], referenceDate?: Date): Trip[] {
  const today = referenceDate ? new Date(referenceDate) : dateUtils.getToday()
  today.setHours(0, 0, 0, 0)
 ...
 * ```
 */
export function filterCompletedTrips(trips: Trip[], referenceDate?: Date): Trip[] {
  const today = referenceDate ? new Date(referenceDate) : dateUtils.getToday()
  today.setHours(0, 0, 0, 0)
 ...
 * ```
 */
export function filterPlanningTrips(trips: Trip[], referenceDate?: Date): Trip[] {
  return trips.filter((trip) => {
