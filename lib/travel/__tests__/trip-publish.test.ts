...
describe('Trip Publish', () => {
  ...
  describe('publishTrip', () => {
    it('should publish a trip successfully', async () => {
      ...
      expect(mockMakeAuthenticatedRequest).toHaveBeenCalledWith('/api/trip/trip-slug/publish', {
        method: 'POST',
        headers: {
    ...
    it('should handle publish errors', async () => {
      ...
      await expect(publishTrip('trip-slug')).rejects.toThrow('Trip is already public')
    })
  })
  ...
  describe('unpublishTrip', () => {
    ...
    it('should handle unpublish errors', async () => {
      ...
      await expect(unpublishTrip('trip-slug')).rejects.toThrow('Trip is already private')
    })
  })
})
