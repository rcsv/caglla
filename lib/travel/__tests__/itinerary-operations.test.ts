...
describe('Itinerary Operations', () => {
  ...
  describe('createItinerary', () => {
    it('should create an itinerary successfully', async () => {
      ...
      expect(mockMakeAuthenticatedRequest).toHaveBeenCalledWith('/api/itineraries', {
        method: 'POST',
        headers: {
  ...
  describe('updateItinerary', () => {
    it('should update an itinerary successfully', async () => {
      ...
      expect(result).toEqual(mockItinerary)
      expect(mockMakeAuthenticatedRequest).toHaveBeenCalledWith('/api/itineraries/itinerary-1', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  describe('deleteItinerary', () => {
    ...
    it('should handle delete errors', async () => {
      ...
      await expect(deleteItinerary('nonexistent-itinerary')).rejects.toThrow('Itinerary not found')
    })
  })
  ...
  describe('reorderItineraries', () => {
    it('should reorder itineraries successfully', async () => {
      ...
      const result = await reorderItineraries('day-1', ['itinerary-1', 'itinerary-2'])

      expect(result).toEqual(mockItineraries)
      expect(mockMakeAuthenticatedRequest).toHaveBeenCalledWith('/api/itineraries/reorder', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    it('should handle reorder errors', async () => {
      ...
      await expect(reorderItineraries('day-1', ['itinerary-1'])).rejects.toThrow('Invalid order')
    })
  })
})
