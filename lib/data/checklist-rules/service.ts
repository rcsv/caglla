		...
		items: [
			{
				...
				longDescription: "checklist.items.currency_exchange_rule.cash_for_exchange.longDescription",
			...
			},
			{
				...
				longDescription: "checklist.items.currency_exchange_rule.passport_for_exchange.longDescription",
				category: "packing",
				priority: "high",
				condition: { type: "always" },
			},
		...
		items: [
			{
				...
				longDescription: "checklist.items.sim_purchase_rule.sim_free_smartphone.longDescription",
				category: "preparation",
				priority: "high",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.sim_purchase_rule.passport_for_sim.longDescription",
				category: "packing",
				priority: "high",
				condition: { type: "always" },
			},
		...
		items: [
			{
				...
				longDescription: "checklist.items.long_stay_rule.common_medicines.longDescription",
				category: "packing",
				priority: "high",
			...
			},
			{
				...
				longDescription: "checklist.items.long_stay_rule.multivitamin.longDescription",
				category: "packing",
				priority: "medium",
			...
			},
			{
				...
				longDescription: "checklist.items.long_stay_rule.folding_umbrella.longDescription",
				category: "packing",
				priority: "medium",
				condition: { type: "duration", minDays: 7 },
			},
			{
				...
				longDescription: "checklist.items.long_stay_rule.charger_mobile_battery.longDescription",
				category: "packing",
				priority: "high",
			...
			},
			{
				...
				longDescription: "checklist.items.long_stay_rule.adapter_plug.longDescription",
				category: "packing",
				priority: "high",
				condition: { type: "duration", minDays: 3 },
			},
		...
		items: [
			{
				...
				longDescription: "checklist.items.train_rule.rail_pass_ticket.longDescription",
				category: "preparation",
				priority: "high",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.train_rule.route_map_app.longDescription",
				category: "preparation",
				priority: "medium",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.train_rule.ic_card.longDescription",
				category: "packing",
				priority: "medium",
		...
		items: [
			{
				...
				longDescription: "checklist.items.bus_rule.bus_ticket_reservation.longDescription",
				category: "preparation",
				priority: "high",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.bus_rule.bus_location_time.longDescription",
				category: "preparation",
				priority: "high",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.bus_rule.neck_pillow_blanket.longDescription",
				category: "packing",
				priority: "low",
				condition: { type: "always" },
			},
		...
		items: [
			{
				...
				longDescription: "checklist.items.taxi_rule.taxi_app_install.longDescription",
				category: "preparation",
				priority: "high",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.taxi_rule.destination_address_memo.longDescription",
				category: "preparation",
				priority: "medium",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.taxi_rule.cash_change.longDescription",
				category: "packing",
				priority: "high",
				condition: { type: "always" },
			},
		...
		items: [
			{
				...
				longDescription: "checklist.items.ferry_rule.ferry_ticket_reservation.longDescription",
				category: "preparation",
				priority: "high",
				condition: { type: "always" },
			},
			{
				...
				title: "checklist.items.ferry_rule.ferry_boarding_time_location.title",
				description: "checklist.items.ferry_rule.boarding_time_location.description",
				longDescription: "checklist.items.ferry_rule.boarding_time_location.longDescription",
				category: "preparation",
				priority: "high",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.ferry_rule.motion_sickness_medicine.longDescription",
				category: "packing",
				priority: "medium",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.ferry_rule.warm_clothing.longDescription",
				category: "packing",
				priority: "medium",
				condition: { type: "always" },
			},
