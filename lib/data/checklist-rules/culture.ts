		...
		items: [
			{
				...
				longDescription: "checklist.items.aquarium_rule.camera_smartphone.longDescription",
				category: "packing",
				priority: "medium",
			...
			},
			{
				...
				longDescription: "checklist.items.aquarium_rule.binoculars.longDescription",
				category: "packing",
				priority: "low",
				condition: { type: "always" },
			},
			{
				...
				longDescription: "checklist.items.aquarium_rule.waterproof_case.longDescription",
				category: "packing",
				priority: "low",
				condition: { type: "always" },
			},
		...
		items: [
			{
				...
				longDescription: "checklist.items.temple_shrine_rule.long_pants_skirt.longDescription",
				category: "packing",
				priority: "high",
			...
			},
			{
				...
				longDescription: "checklist.items.temple_shrine_rule.stole_scarf.longDescription",
				category: "packing",
				priority: "medium",
				condition: { type: "destination", continents: ["AS", "AF"] },
			},
