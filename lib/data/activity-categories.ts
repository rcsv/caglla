...
export const ACTIVITY_CATEGORIES: ActivityCategoryMaster[] = [
	{
		...
		secondaryCategories: [
			...
			},
			{
				...
				icon: "🚆",
				iconName: "train",
				description: "鉄道・地下鉄での移動",
			},
			{
				id: "bus",
				label: "バス",
				icon: "🚌",
				description: "高速バス・市内バス",
			},
			{
				id: "taxi",
				label: "タクシー",
				icon: "🚕",
				description: "タクシー・配車サービス",
			},
			{
				id: "car_rental",
				label: "レンタカー",
		...
		secondaryCategories: [
			{
				...
				label: "お土産購入",
				icon: "🎁",
				description: "お土産・記念品の購入",
			},
			{
				id: "grocery",
				label: "食料品購入",
				icon: "🛒",
				description: "スーパー・コンビニでの買い物",
			},
			{
				id: "fashion",
				label: "ファッション",
				icon: "👔",
				description: "衣類・アクセサリーの購入",
			},
			{
				id: "electronics",
				label: "電化製品",
				icon: "📱",
				description: "家電・ガジェットの購入",
			},
			{
				id: "local_market",
				label: "ローカル市場",
				icon: "🏪",
				description: "地元の市場・バザール",
			},
			{
				id: "duty_free",
				label: "免税店",
				icon: "🛒",
				description: "空港・市内の免税店",
			},
			{
				id: "bookstore",
				label: "書店",
				icon: "📚",
				description: "書籍・雑誌の購入",
			},
		],
	},
	{
		...
		secondaryCategories: [
			...
			{ id: "bar", label: "バー", icon: "🍺", description: "バー・パブ" },
			{
				...
				label: "フードツアー",
				icon: "🍜",
				description: "食べ歩き・グルメツアー",
			},
			{
				id: "street_food",
				label: "屋台・ストリートフード",
				icon: "🌮",
				description: "屋台・フードトラック",
			},
			{
				id: "fine_dining",
				label: "ファインダイニング",
		...
		secondaryCategories: [
			{
				...
				icon: "🔑",
				iconName: "bed",
				description: "ホテル・宿泊施設のチェックイン",
			},
			{
				id: "check_out",
				label: "チェックアウト作業",
				icon: "🚪",
				description: "ホテル・宿泊施設のチェックアウト",
			},
			{
				id: "car_camping",
				label: "車中泊",
			...
			},
			{
				...
				label: "キャンプ",
				icon: "⛺",
				description: "テント・キャンプ場での宿泊",
			},
			{
				id: "hostel_stay",
				label: "ホステル泊",
				icon: "🏠",
				description: "ホステル・ゲストハウス",
			},
			{
				id: "airbnb",
				label: "民泊",
				icon: "🏡",
				description: "Airbnb・民泊施設",
			},
			{
				id: "luxury_hotel",
				label: "高級ホテル",
				icon: "🏰",
				description: "5つ星ホテル・リゾート",
			},
		],
	},
	{
		...
		secondaryCategories: [
			...
			},
			{
				...
				icon: "🌳",
				iconName: "tree",
				description: "公園・自然の中の散歩",
			},
			{
				id: "photography",
				label: "写真撮影",
				icon: "📷",
				description: "景観・建物の撮影",
			},
			{
				id: "observation",
				label: "展望・眺望",
				icon: "🏔️",
				description: "展望台・景色を楽しむ",
			},
			{
				id: "architecture",
				label: "建築鑑賞",
		...
		secondaryCategories: [
			{
				...
				label: "ハイキング",
				icon: "🥾",
				description: "登山道・トレイルハイキング",
			},
			{
				id: "trekking",
				label: "トレッキング",
				icon: "⛰️",
				description: "山岳トレッキング",
			},
			{
				id: "diving",
				label: "ダイビング",
				icon: "🤿",
				description: "スキューバダイビング",
			},
			{
				id: "snorkeling",
				label: "シュノーケリング",
				icon: "🏊",
				description: "シュノーケリング",
			},
			{
				id: "rock_climbing",
				label: "ロッククライミング",
				icon: "🧗",
				description: "クライミング・ボルダリング",
			},
			{
				id: "caving",
				label: "洞窟探検",
				icon: "🕳️",
				description: "洞窟・ケイビング",
			},
			{
				id: "safari",
				label: "サファリ",
				icon: "🦁",
				description: "サファリツアー・動物観察",
			},
			{
				id: "jungle_trek",
				label: "ジャングルトレック",
				icon: "🌴",
				description: "ジャングル・熱帯雨林の探検",
			},
		],
	},
	{
		...
		secondaryCategories: [
			...
			},
			{
				...
				label: "ウォータースポーツ",
				icon: "🏄",
				description: "サーフィン・カヤックなど",
			},
			{
				id: "casino",
				label: "カジノ",
				icon: "🎰",
				description: "カジノ・ギャンブル",
			},
			{
				id: "nightlife",
				label: "ナイトライフ",
				icon: "🌃",
				description: "ナイトクラブ・バー巡り",
			},
			{
				id: "game_center",
				label: "ゲームセンター",
				icon: "🕹️",
				description: "アーケード・ゲームセンター",
			},
			{
				id: "karaoke",
				label: "カラオケ",
	...
	},
	{
		...
		secondaryCategories: [
			...
			},
			{
				...
				label: "美術館",
				icon: "🖼️",
				description: "美術館・ギャラリー",
			},
			{
				id: "aquarium",
				label: "水族館",
				icon: "🐠",
				description: "海洋生物の展示・学習施設",
			},
			{
				id: "temple_shrine",
				label: "寺社仏閣",
				icon: "⛩️",
				description: "寺院・神社・教会",
			},
			{
				id: "historical_site",
				label: "歴史的建造物",
			...
			},
			{
				...
				label: "地域祭り",
				icon: "🎭",
				description: "祭り・フェスティバル",
			},
			{
				id: "theater",
				label: "劇場・コンサート",
				icon: "🎭",
				description: "演劇・音楽コンサート",
			},
			{
				id: "traditional_experience",
				label: "伝統文化体験",
				icon: "🎎",
				description: "茶道・書道などの体験",
			},
			{
				id: "workshop",
				label: "ワークショップ",
				icon: "🎨",
				description: "工芸・アート体験",
			},
		],
	},
	{
		...
		secondaryCategories: [
			{ id: "spa", label: "スパ", icon: "♨️", description: "スパ・温泉" },
			{
				...
				label: "マッサージ",
				icon: "💆",
				description: "マッサージ・リラクゼーション",
			},
			{
				id: "yoga",
				label: "ヨガ",
				icon: "🧘",
				description: "ヨガ・瞑想クラス",
			},
	...
	},
	{
		...
		secondaryCategories: [
			...
			},
			{
				...
				label: "病院",
				icon: "🏥",
				description: "病院・クリニック",
			},
			{
				id: "visa_application",
				label: "ビザ申請",
				icon: "📋",
				description: "大使館・ビザセンター",
			},
			{
				id: "sim_purchase",
				label: "SIM購入",
				icon: "📱",
				description: "SIMカード・通信サービス",
			},
			{
				id: "post_office",
				label: "郵便局",
 ...
 */
export function getActivityCategoryMaster(
	primaryCategory: PrimaryCategoryType,
): ActivityCategoryMaster | undefined {
	return ACTIVITY_CATEGORIES.find(
		(cat) => cat.primaryCategory === primaryCategory,
	);
}
...
export function getSecondaryCategoryInfo(
	...
	return master?.secondaryCategories.find(
...
export function getPrimaryCategoryLabel(
	...
	const translated = t(
		`activity.primary.${primaryCategory}` as unknown as any,
		lang,
	);
 ...
 */
export function getPrimaryCategoryShortLabel(
	primaryCategory: PrimaryCategoryType,
): string {
	const master = getActivityCategoryMaster(primaryCategory);
	if (!master) return primaryCategory;
	const lang = getUserLanguage();
	const translated = t(
		`activity.primaryShort.${primaryCategory}` as unknown as any,
		lang,
	);
...
export function getSecondaryCategoryLabel(
	...
	const lang = getUserLanguage();
	const translated = t(
		`activity.secondary.${primaryCategory}.${secondaryCategoryId}` as unknown as any,
		lang,
	);
...
export function getSecondaryCategoryDescription(
	...
	const lang = getUserLanguage();
	const translated = t(
		`activity.secondary.${primaryCategory}.${secondaryCategoryId}.description` as unknown as any,
		lang,
	);
