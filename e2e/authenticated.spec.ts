...
test.describe('Authentication Mock', () => {
  test('should access authenticated page with mock auth', async ({ authenticatedPage }) => {
  ...
  test('should display user data on authenticated page', async ({ authenticatedPage }) => {
    await authenticatedPage.goto('/home')
    await authenticatedPage.waitForLoadState('networkidle')
