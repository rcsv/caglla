...
export class LandingPage {
  ...
  constructor(page: Page) {
    this.page = page
    this.loginButton = page.locator('button:has-text("ログイン"), button:has-text("Google"), button[data-testid="login-button"]').first()
  ...
  async isLoggedIn(): Promise<boolean> {
    ...
    const userElements = await this.page.locator('[data-testid="user-avatar"], [class*="avatar"]').count()
