            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-600 text-sm">
                  {paymentHelpers.formatPrice(subscriptionStatus.plan.price, subscriptionStatus.plan.currency)}
                </p>
              </div>
              <div className="text-right">
                ...
                {subscriptionStatus.expiresAt && (
                  <p className="text-blue-500 text-xs">
                    有効期限: {subscriptionStatus.expiresAt.toLocaleDateString('ja-JP')}
                  </p>
                )}
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-gray-200">
            ...
            <button
              ...
              disabled={isSubscribing || subscriptionStatus.plan?.id === 'season_traveler'}
            ...
            >
              {isSubscribing ? '処理中...' : 
               subscriptionStatus.plan?.id === 'season_traveler' ? '現在のプラン' : '無料プランに戻る'}
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-blue-500 relative">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-center">
                <span className="text-green-500 mr-3">✓</span>
                <span className="font-semibold text-blue-600">ルート最適化（徒歩・車・電車）</span>
              </li>
              <li className="flex items-center">
                <span className="text-green-500 mr-3">✓</span>
                チェックリスト（カスタム作成）
            ...
            <button
              ...
              disabled={isSubscribing || subscriptionStatus.plan?.id === 'backpacker'}
            ...
            >
              {isSubscribing ? '処理中...' : 
               subscriptionStatus.plan?.id === 'backpacker' ? '現在のプラン' : 'Backpackerプランにアップグレード'}
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-purple-500 relative">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-center">
                <span className="text-green-500 mr-3">✓</span>
                <span className="font-semibold text-purple-600">高度ルート最適化（複合交通）</span>
              </li>
              <li className="flex items-center">
                <span className="text-green-500 mr-3">✓</span>
                同行者との共同編集
            ...
            <button
              ...
              disabled={isSubscribing || subscriptionStatus.plan?.id === 'globetrotter'}
            ...
            >
              {isSubscribing ? '処理中...' : 
               subscriptionStatus.plan?.id === 'globetrotter' ? '現在のプラン' : 'Globetrotterプランにアップグレード'}
            </button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <p><strong>高度:</strong> 複合交通手段での最適化</p>
                <p><strong>効果:</strong> 平均20-30%の時間短縮</p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <p><strong>カスタム:</strong> 透かしなし・カスタムカバー</p>
                <p><strong>プレミアム:</strong> 高解像度・ブランド対応</p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <p><strong>Globetrotter:</strong> 共同編集可能</p>
                <p><strong>権限管理:</strong> 編集者・閲覧者設定</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-center py-3 px-4 font-semibold">Season Traveler</th>
                  <th className="text-center py-3 px-4 font-semibold">Backpacker</th>
                  <th className="text-center py-3 px-4 font-semibold">Globetrotter</th>
                </tr>
              </thead>
              <tbody className="text-gray-600">
                <tr className="border-b">
                  <td className="py-3 px-4">価格</td>
                  <td className="text-center py-3 px-4 font-semibold text-gray-900">無料</td>
                  <td className="text-center py-3 px-4 font-semibold text-blue-600">¥480/月</td>
                  <td className="text-center py-3 px-4 font-semibold text-purple-600">¥980/月</td>
                </tr>
                <tr className="border-b">
                  <td className="py-3 px-4">旅行データ数</td>
                  <td className="text-center py-3 px-4">3件まで</td>
                  <td className="text-center py-3 px-4">10件まで</td>
                  <td className="text-center py-3 px-4 font-semibold text-green-600">無制限</td>
                </tr>
                <tr className="border-b">
                ...
                <tr className="border-b">
                  ...
                  <td className="text-center py-3 px-4 font-semibold text-green-600">5GB</td>
                </tr>
                <tr className="border-b">
                  <td className="py-3 px-4">ルート最適化</td>
                  <td className="text-center py-3 px-4 text-red-500">❌</td>
                  <td className="text-center py-3 px-4 text-green-500">✓ 基本</td>
                  <td className="text-center py-3 px-4 text-green-500">✓ 高度</td>
                </tr>
                <tr className="border-b">
                  <td className="py-3 px-4">共同編集</td>
                  <td className="text-center py-3 px-4 text-red-500">❌</td>
                  <td className="text-center py-3 px-4 text-yellow-500">閲覧のみ</td>
                  <td className="text-center py-3 px-4 text-green-500">✓ 完全</td>
                </tr>
                <tr className="border-b">
                ...
                <tr className="border-b">
                  ...
                  <td className="text-center py-3 px-4 font-semibold text-green-600">高解像度</td>
                </tr>
              </tbody>
            </table>
          </div>
