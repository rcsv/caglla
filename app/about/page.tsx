        ...
        <Section title={t('about.mission.title')}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <SolidCard className="p-8">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('about.mission.simplicity.title')}</h3>
              <p className="text-gray-600">{t('about.mission.simplicity.text')}</p>
            </SolidCard>
            ...
            <SolidCard className="p-8">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('about.mission.collab.title')}</h3>
            ...
            <SolidCard className="p-8">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('about.mission.security.title')}</h3>
        ...
        <Section title={t('about.building.title')}>
          <SolidCard className="p-8 md:p-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('about.building.item1.title')}</h3>
                  <p className="text-gray-700">{t('about.building.item1.text')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('about.building.item2.title')}</h3>
                  <p className="text-gray-700">{t('about.building.item2.text')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('about.building.item3.title')}</h3>
                  <p className="text-gray-700">{t('about.building.item3.text')}</p>
                </div>
              </div>
              </div>
          </SolidCard>
