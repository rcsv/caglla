    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-white py-10">
      <div className="mx-auto max-w-6xl space-y-10 px-4 pb-16">
        <header className="space-y-4">
          <p className="text-sm font-semibold uppercase tracking-wide text-indigo-500">/home concept</p>
          <h1 className="text-3xl font-bold text-slate-900">ホームタイムライン再設計デモ</h1>
  ...
  return (
    <section className="space-y-5">
      {MY_SHARED_TRIPS.map((trip) => (
        <article key={trip.id} className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg md:flex-row md:items-start">
