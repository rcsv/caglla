	...
	}> = [
		{
			...
			items: [
				...
				},
				{
					id: "limits",
					q: "上限/制限はありますか？",
					a: "プラン別に機能やクォータの上限があります。アプリ内のPlanLimitCheckerで確認できます。",
					tags: ["制限"],
				},
			],
		},
			...
			items: [
				{
					id: "create-trip",
					q: "最初の旅はどう作りますか？",
					a: "ヘッダーの「新規作成」または /trip/new から作成できます。",
				},
				{
					id: "add-day",
					q: "Dayを追加する方法は？",
					a: "Trip詳細画面で日付を選択し追加します。Itinerary（予定）をその日に紐づけます。",
				},
				{
					id: "edit-itinerary",
					q: "Itineraryの並び替えはできますか？",
					a: "はい。ドラッグで順序調整、編集・削除にも対応しています。",
				},
				{
					id: "share",
					q: "旅の共有/公開は？",
					a: "Tripの公開設定から切り替えられます。共有リンクのアクセス範囲も制御可能です。",
				},
			],
		},
		{
			...
			items: [
				{
					id: "places-api",
					q: "どのAPIを使っていますか？",
					a: "Google Places API/Maps JavaScript API などを利用します。環境変数の検証が必要です。",
				},
				{
					id: "i18n",
					q: "多言語対応は？",
					a: "i18n仕様に基づき、Placesの多言語・vicinity対応、UIの文字を最小化したアイコン優先設計を採用しています。",
				},
				{
					id: "timezone",
					q: "タイムゾーンはどう処理？",
					a: "timezone-utilsとCITY_TIMEZONE_MAPで都市→TZを解決します。ハードコードは行いません。",
				},
			],
		},
		{
			...
			items: [
				{
					id: "policy",
					q: "プライバシーポリシー",
					a: "詳細は /privacy を参照してください。",
				},
				{ id: "terms", q: "利用規約", a: "詳細は /terms を参照してください。" },
				{
					id: "authz",
					q: "公開・認可は安全ですか？",
					a: "Bearerトークン検証と所有権確認を実装済み（v1.8.2）。適切な401/403/404ハンドリングもあります。",
				},
			],
		},
		{
			...
			items: [
				{
					id: "cannot-login",
					q: "サインインできません",
					a: "ブラウザのCookie/ポップアップ設定を確認。改善しない場合は /contact よりご連絡ください。",
				},
				{
					id: "map-not-loading",
					q: "地図が表示されない",
					a: "APIキーの設定、HTTPリファラー制限、ネットワーク状況を確認してください。",
				},
			],
		},
	];
