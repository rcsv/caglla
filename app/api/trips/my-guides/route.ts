...
export const GET = authApi(
	async (
		request: NextRequest,
		ctx,
	): Promise<NextResponse<MyGuidesResponse>> => {
				...
				return NextResponse.json(
					{
						trips: [],
						error:
							"Firestore index required. Please create a composite index for trips collection: user_id (ascending), is_template (ascending), and updated_at (descending)",
