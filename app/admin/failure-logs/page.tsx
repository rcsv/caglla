      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{timezoneStats.total}</div>
                <div className="text-sm text-gray-600">総数</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-600">{timezoneStats.pending}</div>
                ...
                <div className="space-y-2">
                  {timezoneLogs.slice(0, 10).map((log) => (
                    <div key={log.id} className="border rounded p-3 text-sm">
                      ...
                      <div className="text-gray-600">{log.formatted_address}</div>
                      <div className="text-xs text-gray-500 mt-1">
                        理由: {log.failure_reason} | 
                        都市: {log.detected_city || 'N/A'} | 
                        国: {log.detected_country || 'N/A'}
                      </div>
                    </div>
                  ))}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{currencyStats.total}</div>
                <div className="text-sm text-gray-600">総数</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-600">{currencyStats.pending}</div>
                <div className="text-sm text-gray-600">保留中</div>
              </div>
              <div className="text-center">
